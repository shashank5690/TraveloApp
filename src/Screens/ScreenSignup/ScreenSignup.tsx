...
const ScreenRegister: React.FC<ScreenRegisterProps> = ({navigation}) => {
  ...
  useEffect(() => {
    GoogleSignin.configure({
      webClientId:
        '265851948029-u0d1v01m4c44h1h97uo6l1jqjubichgn.apps.googleusercontent.com',
    });
  }, []);
  ...
  return (
    <View style={styles.container}>
      <Image
        source={require('../ScreenLogin/utils/Assets/star.png')}
      ...
      <View style={styles.socialMediaIcons}>
        <Image
          source={require('../ScreenLogin/utils/Assets/google.png')}
          style={styles.socialIcon}
        />
        <Image
          source={require('../ScreenLogin/utils/Assets/fb.png')}
          style={styles.socialIcon}
        />
        <Image
          source={require('../ScreenLogin/utils/Assets/apple.png')}
          style={styles.socialIcon}
        />
      </View>
